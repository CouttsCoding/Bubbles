...
:: Android packaging
set AND_CERT_NAME="DisasteroidMobile"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\DisasteroidMobile.p12
...
set IOS_PROVISION=cert\DisasteroidMobile.mobileprovision
...
set APP_ID=air.DisasteroidMobile

:: Output packages
set DIST_PATH=dist
set DIST_NAME=DisasteroidMobile

:: Debugging using a custom IP
set DEBUG_IP=192.168.0.250
